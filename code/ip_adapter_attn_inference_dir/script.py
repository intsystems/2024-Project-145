...
class ImageProcessor:
    ...
    def initialize_ip_model(self, weights_path):
        ...
        for k in sd:
            if k.startswith("unet"):
                pass
            elif k.startswith("image_attn_model"):
                image_attn_sd[k.replace("image_attn_model.", "")] = sd[k]
            elif k.startswith("image_proj_model"):
                image_proj_sd[k.replace("image_proj_model.", "")] = sd[k]
            elif k.startswith("adapter_modules"):
                ip_sd[k.replace("adapter_modules.", "")] = sd[k]

        torch.save({"image_proj": image_proj_sd, "image_attn": image_attn_sd, "ip_adapter": ip_sd}, "ip_adapter.bin")
...
if __name__ == "__main__":
    ...
    ip_processor.initialize_ip_model(args.weights_path)

    top_dirs_path = "dataset_persons_images"
